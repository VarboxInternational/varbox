...
class RevisionOptions
{
     ...
     * @return RevisionOptions
     */
    public function enableRevisionOnCreate()
    {
     ...
     * @return RevisionOptions
     */
    public function limitRevisionsTo($limit)
    {
     ...
     * @return RevisionOptions
     */
    public function fieldsToRevision(...$fields)
    {
     ...
     * @return RevisionOptions
     */
    public function relationsToRevision(...$relations)
    {
     ...
     * @return RevisionOptions
     */
    public function disableRevisioningWhenRollingBack()
    {
