@if(isset($uploads) && $uploads->count())
    ...
    @foreach($uploads as $upload)
        <tr>
            <td class="w-1 pl-2">
                <i class="fa fa-file-audio text-blue" style="vertical-align: middle; font-size: 220%;"></i>
            </td>
            <td>
            ...
            <td class="text-right pr-0">
                <a href="{{ $upload->helper->url() }}" target="_blank" class="d-inline btn mr-2 text-yellow">
                    <i class="fe fe-headphones text-yellow mr-2"></i>Listen
                </a>
...
@else
    <p class="px-2 text-muted-dark">No audios found</p>
@endif