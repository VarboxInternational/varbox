    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex text-left">
                ...
                @else
                    {!! button()->saveAndNew() !!}
                    {!! button()->saveAndContinue('admin.cities.edit') !!}
                @endif
                {!! button()->saveRecord() !!}
            </div>
        </div>
...
@push('scripts')
    {!! JsValidator::formRequest(config('varbox.varbox-binding.form_requests.city_form_request', \Varbox\Requests\CityRequest::class), '.frm') !!}
