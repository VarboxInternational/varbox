...
@push('scripts')
    <script type="text/javascript">
        ...
        let treeCreateUrl = '{{ route('admin.pages.create') }}',
            treeLoadUrl = '{{ route('admin.pages.tree.load') }}',
            treeListUrl = '{{ route('admin.pages.tree.list') }}',
            treeSortUrl = '{{ route('admin.pages.tree.sort') }}',
            treeSyncUrl = '{{ route('admin.pages.tree.url') }}';
